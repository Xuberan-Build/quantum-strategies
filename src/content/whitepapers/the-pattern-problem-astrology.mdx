...
The tower does send messages — not through pushing, but through electromagnetic waves. Patterns of energy your instruments couldn't detect because you were measuring the wrong category of thing entirely.

Modern science made the same mistake with astrology. Same category error, same instruments measuring the wrong thing, same confident conclusions.

What makes this more than a measurement problem is where following that error leads: if reality is fundamentally about patterns rather than stuff, then the entire frame through which we dismissed astrology may never have reached the right question.
...
But Carlson's study wasn't the final blow. That honor goes to something simpler: a calculation any physics student can do.
...
At this point there are a few things we know with certainty:
...
The experiment that would actually test this hypothesis looks like this:
...
It doesn't mean your fate is predetermined, or that free will doesn't exist, or that astrologers can predict your future with accuracy, or that zodiac sun signs determine who you are. None of that follows from the hypothesis.

What it does mean is narrower and more concrete: birth timing may create structural templates in the brain — tendencies, not destinies. You're still making choices within those tendencies. Environment and experience still matter enormously. The mechanism, if it exists, is physical. Not mystical.
...
### The Possibility We Keep Avoiding
